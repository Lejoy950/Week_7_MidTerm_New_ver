//buttonplay music:https://www.youtube.com/watch?v=YcezEwOXun4&list=PLRqwX-V7Uu6aFcVjlDAkkGIixw70s7jpW&index=2
...
function setup() {
  ...
  button= createButton("play")//(button of play music)
